...
app.get('/api/daily', async (req, res) => {
	...
	// test query
	// let sqlquery = "select * from master_nutrient where Gender='" + gender + "' and Age=" + age +""
	...
	// let sqlquery = "select `Protein in g`, `Vitamin A retinol equivalents in ug`, `Vitamin C in mg`, `Calcium (Ca) in mg`, `Total Fat in g`, `Total sugars in g` from master_food where `Food Name` Like '%" + item + "%'"
